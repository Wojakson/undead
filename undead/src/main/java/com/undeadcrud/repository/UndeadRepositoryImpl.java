...
//    {}
    ...
    public void createTables() throws SQLException {
        connection.createStatement().executeUpdate("Undead(id int GENERATED BY DEFAULT AS IDENTITY, " + "nazwa varchar(40), " + "typ varchar(40), " + "tier int, lokacja varchar(40), " + "zdolnoscSpecjalna varchar(40))");
    }
